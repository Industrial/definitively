class Definitively < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/Industrial/definitively/releases/download/definitively-v0.1.0/definitively-0.1.0-darwin-arm64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/Industrial/definitively/releases/download/definitively-v0.1.0/definitively-0.1.0-linux-x86_64.tar.gz"
