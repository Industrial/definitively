defmodule Orchestrator.LogTest do
  ...
  setup do
    on_exit(fn ->
      System.delete_env("ORCHESTRATOR_LOG_LEVEL")
      Log.configure!()
    end)
  ...
  test "configured_level parses TRACE" do
    System.put_env("ORCHESTRATOR_LOG_LEVEL", "TRACE")
    Log.configure!()
  ...
  test "configured_level parses DEBUG" do
    System.put_env("ORCHESTRATOR_LOG_LEVEL", "DEBUG")
    Log.configure!()
  ...
  test "configured_level parses WARNING" do
    System.put_env("ORCHESTRATOR_LOG_LEVEL", "WARNING")
    Log.configure!()
    assert Log.configured_level() == :warn
  end

  test "configured_level parses ERROR" do
    System.put_env("ORCHESTRATOR_LOG_LEVEL", "ERROR")
    Log.configure!()
  ...
  test "configured_level handles invalid value" do
    System.put_env("ORCHESTRATOR_LOG_LEVEL", "nope")
    Log.configure!()
    assert Log.configured_level() == :info
  end
  ...
  test "run_metadata builds run context keywords" do
    ctx = %Orchestrator.Workflow.RunContext{
      run_id: "run-1",
