...
overview: Define a ground-up domain model for a YAML-driven development workflow orchestrator (CLI + MCP), separating specification, execution, outcome classification, and FSM orchestration—with optional human approval gates and medium-complexity per-node verdict rules.
todos:
  - id: domain-spec
